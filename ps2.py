...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        self.room.cleanTileAtPosition(current_pos)
...
def runSimulationAnimation(num_robots, speed, width, height, min_coverage, num_trials, robot_type, animate=False):
    total_steps = 0
...
#print(runSimulationAnimation(1, 1.0, 10, 10, 1, 30, StandardRobot, True))
...
#print(runSimulationAnimation(1, 1.0, 10, 10, 0.75, 30, RandomWalkRobot, True))
...
showPlot1('Number of Robot vs Time Steps', 'Number of Robots', 'Time Steps')
...
showPlot2('Aspect ratio vs Time Steps', 'Aspect Ratios', 'Time Steps')